#pragma checksum "/home/q11/桌面/MES/MES_MVC/Views/Home/Dispatch_Page.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "21129209a8cdd8c18080697718b1f5a7236c4e8d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"21129209a8cdd8c18080697718b1f5a7236c4e8d", @"/Views/Home/Dispatch_Page.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "21129209a8cdd8c18080697718b1f5a7236c4e8d3680", async() => {
...
#nullable disable
            WriteLiteral("            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "21129209a8cdd8c18080697718b1f5a7236c4e8d5173", async() => {
#nullable restore
...
#nullable disable
    ...
    <script>
        $(""#order"").change(function(){
            ...
            WriteLiteral("\",order);\n                if(order!=\'請選擇工令編號\'){\n                    $.ajax(\n                        {\n                            url: \"");
#nullable restore
#line 45 "/home/q11/桌面/MES/MES_MVC/Views/Home/Dispatch_Page.cshtml"
...
#nullable disable
            ...
            ");
            WriteLiteral(@"                                $(""tbody"").append(function(){
                                            return ""<tr>""+
            ...
            WriteLiteral(@"          ""</tr>"";
                                            ...
                                            if(item.StaffName!=''){
                                                $(""tbody tr:eq(""+(cou)+"") td select"").append(""<option>""+item.StaffName+""</option>"");        
                                                //$(""tbody tr:eq(""+(cou)+"") td select"").val(""請選擇作業人員"");                                                                                            
                                            }
                                        }
                                        else{
                                            $(""tbody tr:eq(""+(cou-1)+"") td select"").append(""<option>""+item.StaffName+""</option>"");                                            
                                        }                                        
                                    } 
                                    else{             
                                        $(""tbody"").append(function(){
 ");
            WriteLiteral(@"                                           return ""<tr>""+
                                                        //""<td><input type=\""checkbox\""  class=\""form-check-input\"" id=\""time\""  /></td>""+
                                                        ""<td>""+item.Process+""</td>""+
                                                        ""<td>""+item.ProcessName+""</td>""+
                                                        ""<td>""+item.productid+""</td>""+
  ...
  ");
            WriteLiteral(@"                  var value = $(this).find(""select"").val();         
        ...
        $(""#Data_Clear_btn"").click(function(){
            ...
            WriteLiteral(@"value = '請選擇工令編號';
            $(""#order"").trigger(""change"");
        });

        $(""#Data_Dispatch_btn"").on('click',function(){
            var val = document.getElementsByTagName(""tr"");
            var order = document.getElementById(""order"").value;            
            if(order != '請選擇工令編號'){
                var arr = new Array();
            ...
            WriteLiteral(@"ess = process;
                ...
                if(arr.length==0){
                    ...
                    $.ajax(
                    {
                        url: """);
#nullable restore
#line 168 "/home/q11/桌面/MES/MES_MVC/Views/Home/Dispatch_Page.cshtml"
